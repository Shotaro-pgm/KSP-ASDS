...
<head>
    ...
    <title>A.S.D.S</title>
    <meta name="description" content="KSP video creatorとして活動しているShotaroの宇宙開発をまとめたWebサイトです。">
    ...
    <!-- FontAwesome -->
    <script src="https://kit.fontawesome.com/74f11d6ad6.js" crossorigin="anonymous"></script>
    
    <!-- favicon -->
    <link rel="icon" href="img/IMG_8739.jpg">
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-GS2NEQ21WZ"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-GS2NEQ21WZ');
    </script>
</head>
<body>
    <header id="header">
        <a href="index.php" class="logo"><h1>A.S.D.S</h1></a>
        <div class="nav-menu">
            <p id="menu-btn" class="btn menu">menu</p>
            <ul class="nav-list">
                <li><a href="#space-transport" class="btn selector">宇宙運輸部門</a></li>
